export const DATA_SOURCES: string[] = ["eea"];

export const BREEZE_NOTICE = "Created with ❤️ at";
export const BREEZE_NAME = "Breeze Technologies";
export const BREEZE_WEBSITE = "https://www.breeze-technologies.de";
export const JRC_NOTICE =
